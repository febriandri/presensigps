                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="input-icon mb-3">
                                        ...
                                        <input type="text" name="lokasi_kantor" id="lokasi_kantor" value="{{ $lokasi->lokasi_kantor }}" class="form-control" placeholder="Lokasi Kantor">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12">
                                    <div class="input-icon mb-3">
                                        ...
                                        <input type="text" name="radius" id="radius" value="{{ $lokasi->radius }}" class="form-control" placeholder="Radius">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
