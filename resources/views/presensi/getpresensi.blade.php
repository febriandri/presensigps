...
<tr>
    ...
    <td align="center">{!! $d->jam_out != null ? $d->jam_out : '<span class="badge bg-danger text-white">Belum absen</span>' !!}</td>
    <td align="center">
        @if ($d->foto_out)
            @php
    ...
    <td>
        @if ($d->jam_in >= "08:01")
        @php
            $waktuterlambat = selisih("08:01:00", $d->jam_in);
        @endphp
        <span class="badge bg-danger text-white">Terlambat {{ $waktuterlambat }}</span>
        @else
